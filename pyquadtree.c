...
// static PyObject *
// QuadTree_allpoints(QuadTreeObject *self)
// {
//   pqt_allpoints(&self->qt);

//   Py_RETURN_NONE;
// }

static PyObject *
QuadTree_findneighbour(QuadTreeObject *self, PyObject *args)
{
  ...
  if ( PyArg_ParseTuple(args, "fff",
    ...
    pqt_findneighbour(&self->qt,x,y,radius);
  }
...
static PyMethodDef QuadTree_methods[] = {
  ...
  // {"allpoints", (PyCFunction)QuadTree_allpoints, METH_NOARGS,
  //  "list all the points in the Quad Tree"
  // },
  {"findneighbour", (PyCFunction)QuadTree_findneighbour, METH_VARARGS,
...
/*static struct PyModuleDef quadtree =
{
